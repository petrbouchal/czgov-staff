...
plot
SavePlot(plotname = 'Change_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
SavePlot(plotname = 'ChangePaybillNom_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
plot <- ggplot(hh2,aes(x=Year, y=perc_base/Infl2003Base-1, colour=grpcolour)) +
  ...
  scale_x_date(breaks=yearbreaks42003_2012,labels=date_format('%Y'),
               limits = c(as.Date("2003-01-01"), as.Date('2012-01-01'))) +
  labs(title=NULL, x=NULL, y=NULL)
SavePlot(plotname = 'ChangePaybillReal_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
plot
```
...
plot <- ggplot(hh2,aes(Year, perc_base-1, colour=grpcolour, group=grp)) +
  ...
  labs(title=NULL, x=NULL, y=NULL)
plot
SavePlot(plotname = 'ChangeSalNom_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
plot <- ggplot(hh2, aes(Year, realchange-1, colour=grpcolour, group=grp)) +
  ...
  labs(title=NULL, x=NULL, y=NULL)
plot
SavePlot(plotname = 'ChangeSalReal_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
plot <- ggplot(hh2, aes(Year, value*Infl2013Base, colour=grpcolour, group=grp)) +
  ...
  labs(title=NULL, x=NULL, y=NULL)
plot
SavePlot(plotname = 'AvgSal2013CZK_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
plot <- ggplot(hh2, aes(Year, -(value-1), fill=grpcolour, group=grp)) +
  ...
  labs(title=NULL, x=xlab, y=ylab)
plot
SavePlot(plotname = 'StaffGapPerc_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
...
plot <- ggplot(hh2, aes(Year, -(value-1), fill=grpcolour, group=grp)) +
  ...
  labs(title=NULL, x=xlab, y=ylab)
plot
SavePlot(plotname = 'PaybillUnderspends_2003-12_grp_all',ploth=10, plotw=15,plotformat = 'png',)
```
